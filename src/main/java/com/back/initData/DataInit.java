...
public class DataInit {
    ...
    public void makeBasePosts() {
        ...
        Member user1 = getMemberOrThrow("user1");
        Member user2 = getMemberOrThrow("user2");
        Member user3 = getMemberOrThrow("user3");

        Post post1 = postService.write(user1, "제목1", "내용1");
        Post post2 = postService.write(user1, "제목2", "내용2");
        Post post3 = postService.write(user1, "제목3", "내용3");
        Post post4 = postService.write(user2, "제목4", "내용4");
        Post post5 = postService.write(user2, "제목5", "내용5");
        Post post6 = postService.write(user3, "제목6", "내용6");
    }
