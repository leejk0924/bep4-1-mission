...
public class MarketDataInit {
    ...
    public final MarketFacade marketFacade;
    ...
    public void makeBaseOrders() {
        ...
        Order order1 = marketFacade.createOrder(cart1).data();
        Order order2 = marketFacade.createOrder(cart2).data();
        Order order3 = marketFacade.createOrder(cart3).data();
